...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2024 a las 10:16:01
...
ALTER TABLE `credenciales`
  ...
  ADD KEY `fk_persona_credencial` (`idpersona`) USING BTREE;
...
--
ALTER TABLE `credenciales`
  ADD CONSTRAINT `fk_persona_credencial` FOREIGN KEY (`idpersona`) REFERENCES `personas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
